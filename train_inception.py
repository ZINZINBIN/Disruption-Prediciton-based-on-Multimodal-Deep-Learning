...
from src.models.inception import TSInception
...
# parsing
parser = argparse.ArgumentParser(description="training TS inception for disruption classifier")
...
parser.add_argument("--save_best_dir", type = str, default = "./weights/ts_inception_clip_21_dist_3_best.pt")
parser.add_argument("--save_last_dir", type = str, default = "./weights/ts_inception_clip_21_dist_3_last.pt")
parser.add_argument("--save_txt", type = str, default = "./results/test_ts_inception_clip_21_dist_3.txt")
parser.add_argument("--save_conf", type = str, default = "./results/test_ts_inception_clip_21_dist_3_confusion_matrix.png")
parser.add_argument("--save_latent_2d", type = str, default = "./results/ts_inception_clip_21_dist_3_latent_2d.png")
parser.add_argument("--save_latent_3d", type = str, default = "./results/ts_inception_clip_21_dist_3_latent_3d.png")
