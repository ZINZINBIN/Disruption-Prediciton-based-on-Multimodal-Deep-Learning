...
parser.add_argument("--save_best_dir", type = str, default = "./weights/best.pt")
parser.add_argument("--save_result_dir", type = str, default = "./results/train_valid_loss_acc.png")
